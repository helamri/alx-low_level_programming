...
/**
 * strncat_mod - concatenates string with n bytes
 * from another string.
...
/**
 * alloc_mem - allocates memory for output array
 * and sets NULL at string end.
 * @newstr: new string.
 * @str: input string.
 * @str_len: string length.
 *
...
/**
 * word_count - function that counts words in input string.
 * @str: input string.
 * @str_len: string length.
 *
